...
PriceLoss.onTransformerNamChange = function(transformerId) {
  if ($('body').attr('name') == "new") {
    window.location.href = "/ptu3/transformers/" + transformerId + "/information_decision/new";
  } else {
    window.location.href = "/ptu3/transformers/" + transformerId + "/information_decision";
  }
};
